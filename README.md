# ⚡ ESP32 Commercial Greenhouse Multi-Zone Psychrometric Climate Computer
...
Multi-zone agricultural computer controlling motorized ridge vents, shading screens, evaporative wet walls, and CO2 enrichment based on enthalpy calculations.
...
3. Pastikan dependensi pustaka terpasang via Library Manager:
   ...
   * `Wire` & `SPI`
   * `Preferences`
4. Buka berkas [`esp32-commercial-greenhouse-climate.ino`](./esp32-commercial-greenhouse-climate.ino).
