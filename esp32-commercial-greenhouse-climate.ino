/**
 * =========================================================================================
 * Project     : ESP32 Commercial Greenhouse Multi-Zone Psychrometric Climate Computer
 * Platform    : ESP32 (Dual-Core Xtensa LX6 / FreeRTOS)
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Multi-zone agricultural computer controlling motorized ridge vents, shading screens, evaporative wet walls, and CO2 enrichment based on enthalpy calculations.
 * =========================================================================================
 */
...
void TaskTelemetryBroadcaster(void *pvParameters) {
    ...
    for (;;) {
        if (xSemaphoreTake(g_telemetryMutex, pdMS_TO_TICKS(20)) == pdTRUE) {
            ...
            doc["system"] = "esp32-commercial-greenhouse-climate";
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" ESP32 Commercial Greenhouse Multi-Zone Psychrometric Climate Computer"));
